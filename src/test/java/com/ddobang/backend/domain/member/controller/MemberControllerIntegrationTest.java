...
class MemberControllerIntegrationTest {
	...
	void t1() throws Exception {
		...
		resultActions
			...
			.andExpect(jsonPath("$.data.thisMonthInfo.thisMonthCount")
				.value(memberStatResponse.thisMonthInfo().thisMonthCount()))
			.andExpect(jsonPath("$.data.thisMonthInfo.thisMonthAvgSatisfaction")
				.value(memberStatResponse.thisMonthInfo().thisMonthAvgSatisfaction()))
			.andExpect(jsonPath("$.data.thisMonthInfo.thisMonthAvgHintCount")
				.value(memberStatResponse.thisMonthInfo().thisMonthAvgHintCount()))
			.andExpect(jsonPath("$.data.thisMonthInfo.thisMonthSuccessRate")
				.value(memberStatResponse.thisMonthInfo().thisMonthSuccessRate()))
			.andExpect(jsonPath("$.data.thisMonthInfo.thisMonthAvgTime")
				.value(memberStatResponse.thisMonthInfo().thisMonthAvgTime()))
			.andExpect(jsonPath("$.data.thisMonthInfo.thisMonthTopTheme")
				.value(memberStatResponse.thisMonthInfo().thisMonthTopTheme()))
			.andExpect(jsonPath("$.data.thisMonthInfo.thisMonthTopSatisfaction")
				.value(memberStatResponse.thisMonthInfo().thisMonthTopSatisfaction()))
