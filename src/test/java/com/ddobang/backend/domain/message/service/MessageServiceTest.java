...
class MessageServiceTest {
    ...
    void getReceivedMessagesWithCursor() {
        // given
        when(messageRepository.findByReceiverIdAndIdLessThanOrderByIdDesc(eq(receiver.getId()), eq(null), any(Pageable.class)))
                .thenReturn(messages);
        ...
        verify(messageRepository, times(1)).findByReceiverIdAndIdLessThanOrderByIdDesc(eq(receiver.getId()), eq(null), any(Pageable.class));
    }
